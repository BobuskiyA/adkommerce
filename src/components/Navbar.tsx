        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center">
              <img 
                src="/lovable-uploads/e69cde7f-2383-4b10-84ac-de8597479760.png" 
                alt="AdKomemerce Logo" 
                className="h-8 w-auto mr-2" 
              />
              <span className="text-2xl font-bold text-brand-primary font-montserrat">AdKomemerce</span>
            </Link>
          </div>
          ...
          <div className="hidden md:flex md:items-center md:space-x-6">
            ...
            <Button variant="destructive" className="ml-4 font-medium font-inter">
              Get Started
            </Button>
          </div>
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white">
            ...
            <div className="mt-4 px-3">
              <Button variant="destructive" className="w-full font-medium font-inter">
                Get Started
              </Button>
            </div>
          </div>
